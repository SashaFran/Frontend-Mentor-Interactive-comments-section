      ...
      <article className={styles.comment}>
        <aside className={styles.commentScore}>
          <button onClick={incrementScore}>
            <img src="../../interactive-comments-section-main/images/icon-plus.svg" alt="icon plus" />
          </button>
          <span>{score}</span>
          <button onClick={decrementScore}>
            <img src="../../interactive-comments-section-main/images/icon-minus.svg" alt="icon minus" />
          </button>
        </aside>
          ...
          <header className={styles.commentHeader}>
            ...
            <section>
              <button onClick={handleReplyClick}>
                <img src="../../interactive-comments-section-main/images/icon-reply.svg" alt="icon reply" />
                Reply
              </button>
            </section>
          </header>
